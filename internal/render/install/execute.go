...
import (
	...
	"github.com/ccHR0305/webstack-go/internal/proposal/tablesqls"
...
func (h *Handler) Execute() core.HandlerFunc {
	...
	installTableList := map[string]map[string]string{
		...
		"site": {
			"table_sql":      tablesqls.CreateSiteTableSql(),
			"table_data_sql": tablesqls.CreateSiteTableDateSql(),
		},
		"category": {
			"table_sql":      tablesqls.CreateCategoryTableSql(),
			"table_data_sql": tablesqls.CreateCategoryTableDataSql(),
		},
	}
