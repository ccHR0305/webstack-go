...
func (h *handler) Category() core.HandlerFunc {
	return func(ctx core.Context) {
		ctx.HTML("category_view", nil)
	}
}

func (h *handler) Site() core.HandlerFunc {
	return func(ctx core.Context) {
		ctx.HTML("site_list", nil)
	}
}

func (h *handler) AddSite() core.HandlerFunc {
	return func(ctx core.Context) {
		ctx.HTML("site_add", nil)
	}
}
